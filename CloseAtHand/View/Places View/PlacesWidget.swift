...
class PlacesWidget: UIView {
    ...
    private lazy var titleView: UIView = {
        let view = UIView().inputContainerViewForTitle(title: "Places", imageColor: Constant.placesColor, image: Constant.placesIcon)
        return view
    }()
    ...
    func configureUI() {
        ...
        let separator0 = UIView().createSeparator(color: UIColor.init(named: Constant.placesColor)!)
